...
- 日期：2026-09-02
- 状态：待确认（探索完成，开发前需确认）
- 对应官方指引：[`docs/cookbook/adding-a-conversation-node.zh.md`](../../03-practice-plugin/sources/cookbook/adding-a-conversation-node.zh.md)（repo 已有副本）+ 摘要 [`docs/client-plugin.md`](../../03-practice-plugin/notes/client-plugin.md)（早已写好、一直没练）
