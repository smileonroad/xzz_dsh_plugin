...
> 上游：[`sources/cookbook/adding-a-conversation-node.zh.md`](../sources/cookbook/adding-a-conversation-node.zh.md) + deepseek-harness `packages/client/AGENTS.md`（hash 只覆盖本仓库内副本；AGENTS.md 位于 deepseek-harness 源码，不在本仓库）。
