...
> **进度**：8 章全部已落盘。实验源码 **152 个文件**：大部分逐字来自文档代码块，`cordis.yml` 按代码补全，另有 **20 个代码文件** 是「补全件」（按正文 + 同模块源码推得，首行带标记），清单见 [examples/cordis-tutorial/README.md](../../examples/cordis-tutorial/README.md)。
