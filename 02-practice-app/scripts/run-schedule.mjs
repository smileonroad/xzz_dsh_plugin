 ...
 * (02-practice-app/scripts/schedule.cordis.yml = the jsonrpc minimal combination + @deepseek-ai/dsh-schedule).
 *
 *   node 02-practice-app/scripts/run-schedule.mjs "<reminder text>" <after_seconds> [model]
 *
