 ...
 *
 *   node 02-practice-app/scripts/run-headless.mjs "<task>"
 *   node 02-practice-app/scripts/run-headless.mjs --patch 02-practice-app/scripts/model.patch.yml "<task>"
 *
...
for (let i = 2; i < process.argv.length; i++) {
  ...
  if (arg === '--patch') {
    ...
    if (file === undefined) {
      console.error('usage: node 02-practice-app/scripts/run-headless.mjs [--patch <file> ...] "<task>"')
      process.exit(2)
    }
