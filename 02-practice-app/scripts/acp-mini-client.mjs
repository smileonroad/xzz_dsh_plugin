 ...
 * (acp-demo bin + 02-practice-app/scripts/cordis.local.yml) and drives the four-step protocol:
 *
 *   initialize → session/new → session/prompt (streaming) → EOF
 *
 *   node 02-practice-app/scripts/acp-mini-client.mjs "<task>"
 *
...
if (task === '') {
  console.error('usage: node 02-practice-app/scripts/acp-mini-client.mjs "<task>"')
  process.exit(2)
}
